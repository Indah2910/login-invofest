import { Home, HelpCircle, Aperture, AppWindow, CircleUser } from "lucide-react";
...
export const Header: React.FC = () => {
  ...
  const menuItems = [
    ...
    { label: "Competition", href: "/competition", icon: <Aperture size={18} /> },
    { label: "Seminar", href: "/seminar", icon: <AppWindow size={18} /> },
